...
function getCommandConfig(args) {
  ...
  let dist = _path2.default.resolve('demo/dist');
...
function buildDemo(args, cb) {
  (0, _runSeries2.default)([cb => (0, _cleanDemo2.default)(args, cb), cb => (0, _webpackBuild2.default)('demo', args, getCommandConfig, cb)], cb);
}
