...
function devServer(webpackConfig, serverConfig, url, cb) {
  ...
  let { host, open, port } = serverConfig,
      otherServerConfig = _objectWithoutProperties(serverConfig, ['host', 'open', 'port']);

  let webpackDevServerOptions = (0, _webpackMerge2.default)({
    headers: {
  ...
  let server = new _webpackDevServer2.default(compiler, webpackDevServerOptions);
